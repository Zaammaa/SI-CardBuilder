...
{
    internal class BlightTargetOption : TargetOption
    {
        public override string Name => "Blight Target";
        ...
        public override Target OnChosen(Context context)
        {
            ...
            target.landConditions.Add(TargetConditions.LandConditon.LandConditions.Blighted);
            return target;
        }
    }
}
