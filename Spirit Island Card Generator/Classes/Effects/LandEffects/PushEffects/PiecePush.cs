...
{
    public abstract class PiecePush : GeneratorOption, IPowerPowerLevel
    {
        public abstract double BaseProbability { get; }
        public abstract double AdjustedProbability { get; set; }
        public abstract int Complexity { get; }
        private List<IPowerPowerLevel> _children = new List<IPowerPowerLevel>();
        public List<IPowerPowerLevel> Children { get { return _children; } set { _children = value; } }
